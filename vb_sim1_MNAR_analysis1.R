...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.MNAR.res1_10 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.sim1.MNAR.res1_10, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.MNAR.res1_10.RData")
