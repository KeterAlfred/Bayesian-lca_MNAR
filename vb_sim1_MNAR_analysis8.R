...
#Number of datasets
M=10
j=70  # will consider datasets c(1 : M)+j in sim_dat created in the data_for_sim_model1_MNAR_4_groups.R code
...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.MNAR.res71_80 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.sim1.MNAR.res71_80, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.MNAR.res71_80.RData")
